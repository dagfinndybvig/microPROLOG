...
The basic visualization in the present system is pure ASCII so it can work everywhere with just standard Python.

However, at the bottom of this page you will find reference to a JavaScript 3D renderer.

This is what the logical world looks like in the browser, just to give you an idead of what we are dealing with:
